...
In a remote work environment, some of the most common threats include:
Phishing attacks – fake emails or links trying to steal login details
Malware – harmful software from unsafe downloads
Weak passwords – easy-to-guess credentials
Unsecured Wi-Fi – public networks exposing sensitive data
Social engineering – attackers manipulating people to gain access
...
Locking your computer prevents unauthorized access when you are away. Even a few minutes unattended can expose sensitive company data.
...
I reviewed my password storage method and started using a password manager to securely store and generate strong passwords. This helps avoid reusing passwords across different accounts.

## Device Security

I configured my laptop and mobile device to automatically lock after a short period of inactivity. This ensures that no one can access sensitive information when I am away.
